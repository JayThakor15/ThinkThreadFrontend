...
function Footer() {
  const socialIcons = [
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/jayuu_.15/",
      svg: (
        <svg
          className="size-6 transition-transform duration-200 hover:scale-110"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-bold text-blue-400">TalentThread</h3>
            </div>
            <p className="text-gray-400 mb-6 max-w-md mx-auto">
              Connect with professionals, share your expertise, and grow your
              career. The professional networking platform built for the modern
              workforce.
            </p>
